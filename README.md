...
The badge reporting passed/failed test count from [AppVeyor](https://www.appveyor.com/) is generated by the AppVeyor tests branch badge on [shields.io](https://shields.io/#/examples/build).
